"""Subset of immune_system_drugs.csv restricted to approved drugs.

"approved" maps to Open Targets `maxClinicalStage == "APPROVAL"` (the highest
...
OUTPUT = DATA_DIR / "immune_system_drugs_approved.csv"
...
def main():
    ...
    print(f"Kept {kept} approved (maxClinicalStage == {APPROVED_STAGE}) -> {OUTPUT}")
